...
function LunaUI.create()
	...
	NameReal.Text = "Takab Hub | Kaitan Edition"
...
function checklevel()
    ...
    if game.PlaceId == 2753915549 then
		...
		if MYLEVEL == 1 or MYLEVEL <= 9 then -- Bandit
				...
				elseif MYLEVEL == 15 or MYLEVEL <= 74 then
				    magbring = 200
				    _G.QuestAccept = false
				...
				elseif MYLEVEL == 75 or MYLEVEL <= 89 then
    			    ...
    			    if _G.FARM and (_G.QUESTMON.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 10000 then
...
spawn(function()
        ...
        Page:Toggle("Auto Superhuman", false, function(sp)
            _G.Superhuman = sp
        end)
        
         Page:Toggle("Auto FullSuperhuman", false, function(sps)
...
Page6:Line()
Page6:Label("Walk on Water")

	
	Page6:Toggle("Walk on Water",false,function(Value)
		_G.WalkWater2 = Value
	end)
...
--[[Page:Button("Fix FastAttack",function()
spawn(function()
            while wait() do
                pcall(function()
                    --if _G.Fastatk and _G.FARM or _G.Fastatk and Auto_Bone then
...
spawn(function()
    pcall(function()
        while task.wait(0.5) do
            if methodcheck == 1 then
                method = CFrame.new(0,25,0)
                methodcheck = 2
            elseif methodcheck == 2 then
                method = CFrame.new(25,0,0)
                methodcheck = 3
            elseif methodcheck == 3 then
                method = CFrame.new(0,0,25)
                methodcheck = 4
            elseif methodcheck == 4 then
                method = CFrame.new(-25,0,0)
                methodcheck = 5
            elseif methodcheck == 5 then
                method = CFrame.new(0,0,-25)
                methodcheck = 1
            end
        end
...
spawn(function()
            while game:GetService("RunService").RenderStepped:wait() do
                if _G.FARM then
                        ...
                        if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                            ...
                            if game:GetService("Workspace").Enemies:FindFirstChild(_G.Mon) then
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    TitleQuest = string.sub(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,10,10)
                                    TitleNameMon = string.sub(_G.NameMon,1,1)
                                    if not string.find(TitleQuest,  TitleNameMon) then
                                        ...
                                        if v.Name == _G.Mon  then
                                            if v.Humanoid.Health > 0 then
                                                repeat game:GetService("RunService").Heartbeat:wait()
                                                            TP(v.HumanoidRootPart.CFrame * method)
                                    ...
                                    MagnetActive = false
                                    checklevel()
                                repeat TP(_G.PUK) wait() until _G.StopTween == true or not _G.FARM or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - _G.PUK.Position).Magnitude <= 8
                            end
                    ...
                    elseif _G.QuestAccept == false then
                        if game:GetService("Workspace").Enemies:FindFirstChild(_G.Mon) then
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
			...
			spawn(function()
				while task.wait() do
					pcall(function()
						checklevel()
						for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
							if _G.FARM and MagnetActive then
								if v.Name == _G.Mon then
									if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
										if (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= magbring then--350
